...
latest = "5.3.45" # TODO: Needs to be dynamic -> https://api.github.com/repos/Templarian/MaterialDesign-Webfont/branches
data_version = latest
def font_url(): 
...
if "g" in options or "h" in options:
	...
	generateFile(s)
if "f" in options:
	font = urllib.request.urlretrieve(font_url(), "build/fonts/mdi-" + data_version + ".ttf")
